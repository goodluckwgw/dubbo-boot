...
import com.github.bootcommon.utils.Digests;
import com.github.bootcommon.utils.Encodes;
import com.github.bootcommon.utils.Ids;
import com.github.bootimpl.domain.Account;
import com.github.bootimpl.repository.AccountDao;
...
public class AccountService {
	...
	public Account getLoginUser(String token) {
		...
		if (account == null) {
			throw new ServiceException("User doesn't login",
	...
	public void register(String email, String name, String password) {
	  ...
	  protected static String hashPassword(String password) { return
	    Encodes.encodeBase64(Digests.sha1(password)); }
